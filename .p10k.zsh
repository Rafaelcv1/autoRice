# Generated by Powerlevel10k configuration wizard on 2025-12-05 at 16:38 -03.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 4949.
...
() {
  ...
  ####################[ yazi: yazi shell (https://github.com/sxyazi/yazi) ]#####################
  # Yazi shell color.
  typeset -g POWERLEVEL9K_YAZI_FOREGROUND=235
  ...
  typeset -g POWERLEVEL9K_LOAD_WARNING_BACKGROUND=235
